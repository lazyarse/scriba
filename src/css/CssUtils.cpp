...
QString deriveChromeCss(const QString &themeCss, int uiFontSizePt)
{
    ...
    return QStringLiteral(
        ...
        "#scriba-editor QScrollBar:vertical { width: 20px; }\n"
        "#scriba-editor QScrollBar::handle:vertical { border-radius: 10px; }\n"
        ...
        "QTabBar::tab { background-color: %2; color: %3; padding: 6px 16px; border: none; border-bottom: 1px solid %4; border-top-left-radius: 6px; border-top-right-radius: 6px; }\n"
